      ...
      <div class="modal-body">
        <div class="d-flex justify-content-around gap-2 mb-3">
          ...
          <div>
            ...
            <button class="btn btn-sm btn-outline-dark" data-bs-target="#ModifyEventModal" data-bs-toggle="modal"> <svg
            ...
            <button class="btn btn-sm btn-outline-danger" data-bs-target="#DeleteEventModal" data-bs-toggle="modal"><svg
        ...
        <div class="my-2">
          <a v-if="isUrl" :href="event.details.link">Risorsa o luogo</a>
          <span v-else>
            {{ event.details.link }}
          </span>
        </div>
