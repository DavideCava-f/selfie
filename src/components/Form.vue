...
function validateForm(){
    ...
    while(!found && i < UserEx.length){
        if((username === UserEx[i].username || username===UserEx[i].email ) && pswd === UserEx[i].password){
            ...
            <div class="col-xl-10">
                ...
                <div class="row g-0">
                    ...
                    <div class="card-body p-md-5 mx-md-4">
                        ...
                        <img src="@/assets/UniboLogo.png"
                            style="width: 185px;" alt="logo">
                        </div>

                        <form name="login" v-if="currentRoute === '/login'" onsubmit="validateForm()">
                            ...
                            <div class="text-center pt-1 mb-5 pb-1">
                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" @click="validateForm">Log
                                in</button>
                        ...
                        <form name="signup" v-if="currentRoute === '/signup'" class="was-validated" onsubmit="addUser">
                            ...
                            <div class="invalid-feedback">Please choose a programme.</div>
                            ...
                            <div class="text-center pt-1 mb-5 pb-1">
                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-danger btn-block fa-lg gradient-custom-2 mb-3" type="submit" @click="addUser">Sign up</button>
                            </div>

                            <div class="d-flex align-items-center justify-content-center pb-4">
                                <p class="mb-0 me-2">You already have an account?</p>
                                <router-link to="/login">
                                    <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-primary">Log in </button>
                                </router-link>
                            </div>
                    ...
                    <div class="text-black px-3 py-4 p-md-5 mx-md-4">
                        ...
                        <h3 class="mb-4">Studying and Enjoying Life with Friends In Education</h3>
