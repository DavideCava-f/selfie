            ...
            <div class="col-xl-10">
                ...
                <div class="row g-0">
                    ...
                    <div class="card-body p-md-5 mx-md-4">
                        ...
                        <form name="signup" v-if="currentRoute === '/signup'" onsubmit="return validateForm()">
                            ...
                            <select class="form-select mb-1" aria-label="Programme" id="corsi">
                                <option selected disabled value="">Choose...</option>
                                <option v-for="corso in corsi" value=${corso.index} class="text-black">
                                    {{ corso }}
                                </option> 
                            </select>
                            ...
                            <div class="text-center pt-1 mb-5 pb-1">
                                <button data-mdb-button-init data-mdb-ripple-init class="btn btn-danger btn-block fa-lg gradient-custom-2 mb-3" type="submit">Sign up</button>
                            </div>
