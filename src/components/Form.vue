                                    ...
                                    <form name="login" v-if="!SignUp" action="validateForm" class="novalidate">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-text">
                                                    <svg style="display: none" xmlns="http://www.w3.org/2000/svg"
                                                        id="see" @click="seePswd" width="16" height="16"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" id="notsee" @click="seePswd"
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <button data-mdb-button-init data-mdb-ripple-init
                                                ...
                                                type="submit" @click.prevent="validateForm">
                                                Log in
                                            </button>
                                        </div>
                                    ...
                                    <form name="signup" v-if="SignUp" class="was-validated" onsubmit="addUser">
                                        ...
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-text">
                                                    <svg style="display: none" xmlns="http://www.w3.org/2000/svg"
                                                        id="csee" @click="cseePswd" width="16" height="16"
                                                        fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                                        <path
                                                            d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z" />
                                                        <path
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" id="cnotsee"
                                                        @click="cseePswd" width="16" height="16" fill="currentColor"
                                                        class="bi bi-eye-slash" viewBox="0 0 16 16">
                                                        <path
                                                            d="M13.359 11.238C15.06 9.72 16 8 16 8s-3-5.5-8-5.5a7 7 0 0 0-2.79.588l.77.771A6 6 0 0 1 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755q-.247.248-.517.486z" />
                                                        <path
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <button data-mdb-button-init data-mdb-ripple-init
                                                ...
                                                type="submit" @click.prevent="addUser">
                                                Sign up
                                            </button>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            ...
                                            <button type="button" data-mdb-button-init data-mdb-ripple-init
                                                class="btn btn-outline-primary" @click="SignUp = false">
                                                Log in
                                            </button>
                                        </div>
                                    </form>
