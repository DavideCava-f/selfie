...
<div class="col">
  ...
  <button class="btn btn-primary rounded-circle fx-button d-flex align-items-center justify-content-center hover-div " style="position: fixed; right: 0; bottom: 0"
